	...
	<bg>
		...
		<template #first>
			<chart-bg name="积分总数">
				<!-- 给chart-bg组件传具体的图表 -->
				<template #main>
					<first-left pos="neighborhood-first-left"></first-left>
				</template>
			</chart-bg>
		</template>
		<template #second>
			<chart-bg name="积分来源">
				<!-- 给chart-bg组件传具体的图表 -->
				<template #main>
					<second-left pos="neighborhood-second-left"></second-left>
				</template>
			</chart-bg>
		</template>
		<template #third>
			<chart-bg name="积分趋势">
				<!-- 给chart-bg组件传具体的图表 -->
				<template #main>
					<third-left pos="neighborhood-third-left"></third-left>
				</template>
			</chart-bg>
		</template>
		<template #forth>
			<chart-bg name="用户积分分析">
				<!-- 给chart-bg组件传具体的图表 -->
				<template #main>
					<forth-left pos="neighborhood-forth-left"></forth-left>
				</template>
			</chart-bg>
		</template>
